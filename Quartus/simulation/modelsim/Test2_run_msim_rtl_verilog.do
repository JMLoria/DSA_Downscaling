...
vlog -vlog01compat -work work +incdir+D:/TestProyecto2 {D:/TestProyecto2/ram.v}
vlog -sv -work work +incdir+D:/TestProyecto2 {D:/TestProyecto2/instruction_handler_memory_tb.sv}
vlog -sv -work work +incdir+D:/TestProyecto2 {D:/TestProyecto2/memory_interface.sv}
vlog -sv -work work +incdir+D:/TestProyecto2 {D:/TestProyecto2/img_writer.sv}
vlog -sv -work work +incdir+D:/TestProyecto2 {D:/TestProyecto2/instruction_handler.sv}
...
vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  instruction_handler_memory_tb
